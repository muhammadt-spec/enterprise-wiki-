...
class space_create(Tool):
    ...
    def invoke(
        ...
        if space_create._space_by_key(spaces, key):
        ...
        sid = space_create._gen_id(spaces)
        rec = {
            "space_id": sid,
            "space_key": key,
            "name": name,
            ...
            "created_at": space_create._now(),
            "updated_at": space_create._now()
        }
        spaces[sid] = rec
