...
class manage_space(Tool):
    ...
    def invoke(
        ...
        if manage_space._space_by_key(spaces, key):
        ...
        sid = manage_space._gen_id(spaces)
        rec = {
            "space_id": sid,
            "space_key": key,
            "name": name,
            ...
            "created_at": manage_space._now(),
            "updated_at": manage_space._now()
        }
        spaces[sid] = rec
