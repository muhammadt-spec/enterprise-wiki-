...
class space_create_entry(Tool):
    ...
    def invoke(
        ...
        if space_create_entry._space_by_key(spaces, key):
        ...
        sid = space_create_entry._gen_id(spaces)
        rec = {
            "space_id": sid,
            "space_key": key,
            "name": name,
            ...
            "created_at": space_create_entry._now(),
            "updated_at": space_create_entry._now()
        }
        spaces[sid] = rec
