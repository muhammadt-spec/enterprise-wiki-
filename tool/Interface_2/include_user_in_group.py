...
class IncludeUserInGroup(Tool):
    ...
    @staticmethod
    def get_info():
        return {"type":"function","function":{"name":"include_user_in_group","description":"Add a user to an existing group.","parameters":{"type":"object","properties":{"group_id":{"type":"string","description":"Group ID"},"user_id":{"type":"string","description":"User ID to add"}},"required":["group_id","user_id"]}}}
