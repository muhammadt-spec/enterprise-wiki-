...
class RegisterGroupEntity(Tool):
    ...
    def invoke(data: Dict[str, Any], group_name: str, description: Optional[str] = None) -> str:
        ...
        new_id = RegisterGroupEntity._generate_id(groups)
    ...
    @staticmethod
    def get_info():
        return {"type":"function","function":{"name":"register_group_entity","description":"Create a new group.","parameters":{"type":"object","properties":{"group_name":{"type":"string","description":"Unique group name"},"description":{"type":"string","description":"Group description"}},"required":["group_name"]}}}
