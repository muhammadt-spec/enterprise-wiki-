...
class AddAttachmentToPage(Tool):
    ...
    def invoke(data: Dict[str, Any], page_id: str, filename: str, mime_type: str,
        ...
        new_id = add_attachment_to_page._generate_id(attachments)
