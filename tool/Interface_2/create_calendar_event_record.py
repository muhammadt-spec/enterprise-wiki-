...
class CreateCalendarEventRecord(Tool):
    ...
    def invoke(data: Dict[str, Any], calendar_id: str, title: str, start_at: str,
        ...
        new_id = CreateCalendarEventRecord._generate_id(events)
