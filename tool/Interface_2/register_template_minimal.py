...
class RegisterTemplateMinimal(Tool):
    ...
    def invoke(data: Dict[str, Any], name: str, scope: str, owner_id: str,
        ...
        new_id = RegisterTemplateMinimal._generate_id(templates)
