...
class AddRestrictionSubjects(Tool):
    """
    ...
    def invoke(
        data: Dict[str, Any],
        restrictions_id: str,
        users_view: List[str] = None,
        users_edit: List[str] = None,
        groups_view: List[str] = None,
        groups_edit: List[str] = None
    ) -> str:
