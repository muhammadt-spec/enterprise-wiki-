...
class CreateRestrictionSet(Tool):
    """
    ...
    def invoke(
        ...
        new_id = CreateRestrictionSet._generate_id(restriction_sets)
        rec = {
            "restrictions_id": new_id,
    ...
    def get_info():
        return {
          "type": "function",
          "function": {
            "name": "create_restriction_set",
            "description": "Create a restriction set to be applied on pages.",
            "parameters": {
              "type": "object",
              "properties": {
                "restriction_type": {"type": "string", "description": "Restriction type (none | edit_only | view_and_edit)"}
              },
