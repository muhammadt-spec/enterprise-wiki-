...
class ApplyLabelToPage(Tool):
    ...
    def invoke(
        ...
        if key in page_labels:
            return json.dumps({"error": "Label already applied to page"})

        rec = {
            "page_id": page_id,
            "label_id": label_id,
            "applied_at": "2025-10-01T00:00:00"
        }
        page_labels[key] = rec
    ...
    def get_info():
        return {
          "type": "function",
          "function": {
            "name": "apply_label_to_page",
            "description": "Apply an existing label to a page.",
            "parameters": {
              "type": "object",
              "properties": {
                "page_id": {"type": "string", "description": "Target page_id"},
                "label_id": {"type": "string", "description": "Existing label_id"}
              },
