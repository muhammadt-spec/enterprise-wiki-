...
class TransitionPageWorkflow(Tool):
    """
    ...
    def invoke(
        ...
        new_id = TransitionPageWorkflow._generate_id(transitions)
        rec = {
        ...
        # also update page workflow_state if desired
        p = pages[page_id]
