...
class CreateSla(Tool):
    ...
    def invoke(
        ...
        new_id = CreateSla._generate_id(slas)
        rec = {
            "sla_id": new_id,
    ...
    def get_info():
        return {
          ...
          "function": {
            "name": "create_sla",
            "description": "Create a new SLA policy for a service and priority.",
            "parameters": {
              "type": "object",
              "properties": {
                "service_id": {"type": "string", "description": "Service ID"},
                "priority": {"type": "string", "description": "Priority (P1 | P2 | P3 | P4 | P5)"},
                "response_target_minutes": {"type": "integer", "description": "Response target in minutes"},
                "resolution_target_minutes": {"type": "integer", "description": "Resolution target in minutes"},
                "active": {"type": "boolean", "description": "Whether SLA is active (True/False)"}
              },
              "required": ["service_id", "priority", "response_target_minutes", "resolution_target_minutes"]
            }
          }
        }
