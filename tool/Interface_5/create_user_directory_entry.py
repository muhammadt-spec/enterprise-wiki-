...
class CreateUserDirectoryEntry(Tool):
    ...
    def invoke(data: Dict[str, Any], full_name: str, email: str, status: str = "Active",
        ...
        new_id = CreateUserDirectoryEntry._generate_id(users)
        rec = {
    ...
    def get_info() -> Dict[str, Any]:
        return {
            "type":"function",
            "function":{
                "name":"create_user_directory_entry",
                ...
                "parameters":{
                    ...
                    "properties":{
                        ...
                        "status":{"type":"string","description":"User status (Active | Suspended | Deactivated)"},
