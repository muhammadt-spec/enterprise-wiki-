...
class PublishLabelTerm(Tool):
    ...
    def invoke(data: Dict[str, Any], label_text: str, scope: str = "Global",
        ...
        new_id = PublishLabelTerm._generate_id(labels)
    ...
    @staticmethod
    def get_info():
        return {"type":"function","function":{"name":"publish_label_term","description":"Create a new label in Global or Space scope.","parameters":{"type":"object","properties":{"label_text":{"type":"string","description":"Label text"},"scope":{"type":"string","description":"Label scope (Global | Space)"},"space_id":{"type":"string","description":"Required if scope=Space: target space_id"},"created_by":{"type":"string","description":"User ID creating this label"}},"required":["label_text"]}}}
