...
class ScheduleCalendarEvent(Tool):
    ...
    def invoke(data: Dict[str, Any], calendar_id: str, title: str, start_at: str,
        ...
        new_id = ScheduleCalendarEvent._generate_id(events)
