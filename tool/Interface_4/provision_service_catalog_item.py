...
class ProvisionServiceCatalogItem(Tool):
    ...
    def invoke(data: Dict[str, Any], name: str, business_criticality: str, owner_group_id: str, status: str = "Active") -> str:
        ...
        new_id = ProvisionServiceCatalogItem._generate_id(services)
    ...
    @staticmethod
    def get_info():
        return {"type":"function","function":{"name":"provision_service_catalog_item","description":"Create a new service with business criticality.","parameters":{"type":"object","properties":{"name":{"type":"string","description":"Unique service name"},"business_criticality":{"type":"string","description":"Criticality (Low | Medium | High | Critical)"},"owner_group_id":{"type":"string","description":"Owner group_id"},"status":{"type":"string","description":"Service status (Active | Retired)"}},"required":["name","business_criticality","owner_group_id"]}}}
