...
class EstablishSlaPolicy(Tool):
    ...
    def invoke(data: Dict[str, Any], service_id: str, priority: str,
        ...
        new_id = EstablishSlaPolicy._generate_id(slas)
