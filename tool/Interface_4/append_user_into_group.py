...
class AppendUserIntoGroup(Tool):
    ...
    @staticmethod
    def get_info():
        return {"type":"function","function":{"name":"append_user_into_group","description":"Add a user to an existing group.","parameters":{"type":"object","properties":{"group_id":{"type":"string","description":"Group ID"},"user_id":{"type":"string","description":"User ID to add"}},"required":["group_id","user_id"]}}}
