...
class AffixLabelToPage(Tool):
    ...
    @staticmethod
    def get_info():
        return {"type":"function","function":{"name":"affix_label_to_page","description":"Apply an existing label to a page.","parameters":{"type":"object","properties":{"page_id":{"type":"string","description":"Target page_id"},"label_id":{"type":"string","description":"Existing label_id"}},"required":["page_id","label_id"]}}}
