...
class SpawnRestrictionSet(Tool):
    ...
    def invoke(data: Dict[str, Any], restriction_type: str) -> str:
        ...
        new_id = SpawnRestrictionSet._generate_id(restriction_sets)
    ...
    @staticmethod
    def get_info():
        return {"type":"function","function":{"name":"spawn_restriction_set","description":"Create a restriction set to be applied on pages.","parameters":{"type":"object","properties":{"restriction_type":{"type":"string","description":"Restriction type (none | edit_only | view_and_edit)"}},"required":["restriction_type"]}}}
