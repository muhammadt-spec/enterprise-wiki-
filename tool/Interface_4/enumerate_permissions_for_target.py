...
class EnumeratePermissionsForTarget(Tool):
    ...
    @staticmethod
    def get_info():
        return {"type":"function","function":{"name":"enumerate_permissions_for_target","description":"List permission sets and grants for a target entity (space/page/global).","parameters":{"type":"object","properties":{"target_id":{"type":"string","description":"Target entity id (space_id or page_id or global target id)"}},"required":["target_id"]}}}
