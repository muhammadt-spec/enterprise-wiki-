...
class SeedPermissionSetBundle(Tool):
    ...
    def invoke(data: Dict[str, Any], level: str, target_id: str, version: str) -> str:
        ...
        new_id = SeedPermissionSetBundle._generate_id(permission_sets)
    ...
    @staticmethod
    def get_info():
        return {"type":"function","function":{"name":"seed_permission_set_bundle","description":"Create a permission_set at Global, Space, or Page scope.","parameters":{"type":"object","properties":{"level":{"type":"string","description":"Permission level (Global | Space | Page)"},"target_id":{"type":"string","description":"ID of target entity (e.g., space_id or page_id)"},"version":{"type":"string","description":"Version tag/label for the permission set"}},"required":["level","target_id","version"]}}}
