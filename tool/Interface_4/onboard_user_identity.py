...
class OnboardUserIdentity(Tool):
    ...
    def invoke(data: Dict[str, Any], full_name: str, email: str, status: str = "Active",
        ...
        new_id = OnboardUserIdentity._generate_id(users)
        rec = {
    ...
    def get_info() -> Dict[str, Any]:
        return {"type":"function","function":{"name":"onboard_user_identity","description":"Create a new user record.","parameters":{"type":"object","properties":{"full_name":{"type":"string","description":"Full name of the user"},"email":{"type":"string","description":"Unique email address"},"status":{"type":"string","description":"User status (Active | Suspended | Deactivated)"},"timezone":{"type":"string","description":"IANA timezone string"},"position":{"type":"string","description":"Job position/role"},"department":{"type":"string","description":"Department name"},"location":{"type":"string","description":"User location"},"about_me":{"type":"string","description":"Short bio"},"phone":{"type":"string","description":"Phone number"}},"required":["full_name","email"]}}}
