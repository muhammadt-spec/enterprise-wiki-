...
class PersistTemplateBlueprint(Tool):
    ...
    def invoke(data: Dict[str, Any], name: str, scope: str, owner_id: str,
        ...
        new_id = PersistTemplateBlueprint._generate_id(templates)
