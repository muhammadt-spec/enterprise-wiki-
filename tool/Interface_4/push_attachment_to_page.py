...
class PushAttachmentToPage(Tool):
    ...
    def invoke(data: Dict[str, Any], page_id: str, filename: str, mime_type: str,
        ...
        new_id = PushAttachmentToPage._generate_id(attachments)
