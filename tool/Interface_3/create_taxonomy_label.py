...
class CreateTaxonomyLabel(Tool):
    ...
    def invoke(data: Dict[str, Any], label_text: str, scope: str = "Global",
        ...
        labels = data.get("labels", {}); users = data.get("users", {}); spaces = data.get("spaces", {})
        ...
        new_id = CreateTaxonomyLabel._generate_id(labels)
    ...
    @staticmethod
    def get_info():
        return {"type":"function","function":{"name":"create_taxonomy_label","description":"Create a new label in Global or Space scope.","parameters":{"type":"object","properties":{"label_text":{"type":"string","description":"Label text"},"scope":{"type":"string","description":"Label scope (Global | Space)"},"space_id":{"type":"string","description":"Required if scope=Space: target space_id"},"created_by":{"type":"string","description":"User ID creating this label"}},"required":["label_text"]}}}
