...
class CreateTeamGrouping(Tool):
    ...
    def invoke(data: Dict[str, Any], group_name: str, description: Optional[str] = None) -> str:
        ...
        new_id = CreateTeamGrouping._generate_id(groups)
    ...
    @staticmethod
    def get_info():
        return {"type":"function","function":{"name":"create_team_grouping","description":"Create a new group.","parameters":{"type":"object","properties":{"group_name":{"type":"string","description":"Unique group name"},"description":{"type":"string","description":"Group description"}},"required":["group_name"]}}}
