...
class BootstrapPermissionSet(Tool):
    ...
    def invoke(data: Dict[str, Any], level: str, target_id: str, version: str) -> str:
        ...
        new_id = BootstrapPermissionSet._generate_id(permission_sets)
